...
public class OpponentName implements APAPIPlaceholder {
	...
	public String getValue(Player player) {
		...
		assert match != null;
		if(player == match.player1) return PlaceholderAPI.setPlaceholders(match.player2, match.player2.getName());
		else return PlaceholderAPI.setPlaceholders(match.player1, match.player1.getName());
	}
}
