...
//		attackEvent.multiplier.add(getDamageMultiplier(enchantLvl));
	...
	public List<String> getDescription(int enchantLvl) {
		...
		return new ALoreBuilder("&7Hits with this sword deal",
				"&c+" + decimalFormat.format(getDamageIncrease(enchantLvl)) + "% damage &7but cost &6" + getGoldCost(enchantLvl) + "g").getLore();
	}

	public double getDamageIncrease(int enchantLvl) {
		if(enchantLvl % 3 == 0) return (double) (enchantLvl / 3) * 100;
